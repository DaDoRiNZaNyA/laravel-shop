    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input value="{{ $product->price }}" type="number" name="price" class="form-control" placeholder="price">
                </div>
                <div class="form-group">
                    <input value="{{ $product->count }}" type="number" name="count" class="form-control" placeholder="count">
                </div>
                <div class="form-group">
